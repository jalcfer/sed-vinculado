...
class MyTriggersHandlers {
    ...
    static rolInstitucionalHandler(triggerObj) {
        try {
            ...
            if (triggerObj.triggerValues.indexOf(editedValue) !== -1) {
                ...
                var docenteList = getDataViewRepository().getListDataWithJoin('IEO_Docente', ['Docente'], ['Nombre_docente', 'Apellido_docente'], [
...
function rolInstitucionalHandler(triggerObj) {
    MyTriggersHandlers.rolInstitucionalHandler(triggerObj);
}
function areaHandler(triggerObj) {
