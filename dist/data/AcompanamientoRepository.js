...
class AcompanamientoRepository_ {
    ...
    getLastJornadaNumber(acompId) {
        ...
        return Math.max(...result.map((r) => r.Numero_jornada));
    }
    /**
     ...
     */
    updatePaFolderInformes(paId, folderId) {
        const dataToUpdate = { ID_Folder_informes: folderId };
        this.db.update('Profesional_Acompanamiento', dataToUpdate, { ID_Profesional_Acompanamiento: paId });
    }
}
function getAcompanamientoRepository() {
