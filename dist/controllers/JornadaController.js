...
function iniciarJornada_() {
    ...
    try {
        ...
        const result = ui.prompt('Iniciar Jornada', 'Ingrese el número de participantes:', ui.ButtonSet.OK_CANCEL);
        ...
        getNotificationService().runProcessWithFeedback("Crear Jornada de Acompañamiento", "se ha iniciado una nueva jornada de acompañamiento.", createProcess);
    }
    catch (e) {
        const error = e;
