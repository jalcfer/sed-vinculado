...
class JornadaService {
   ...
   */
  public iniciarJornada(reportProgress: (message: string) => void): { fecha: Date; numeroJornada: number; nombreIEO: string } {
    ...
    PropertiesService.getScriptProperties().setProperty(appConfig.properties.ID_IEO_KEY,String(parseInt(info.ID_IEO as string, 10)));
   ...
   */
  public registrarLogrosDificultadesAcuerdos(visitaId: number, datos: LogrosDificultadesAcuerdosDTO): void {
